                        ...
                        <form method="post" action="{{ route('contacts.store') }}">
                            ...
                            <div class="container px-5 py-0 mx-auto">
                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="relative">
                                        <label for="name1" class="leading-7 text-sm text-gray-600">名前</label>
                                        <input type="text" id="name1" name="name1" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    </div>
                                    </div>
